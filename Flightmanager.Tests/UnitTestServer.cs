...
public void UpdateFlight_ReturnsNotFound_WhenFlightDoesNotExist()
{
    ...
    var updatedFlight = new Flight { Id = 1, FlightNumber = "FN124" };
...
[Fact]
public void GetAll_ReturnsOkResult_WithFlightList()
{
    // Arrange
    var options = new DbContextOptionsBuilder<ApiContext>()
        .UseInMemoryDatabase(databaseName: "GetAllTestDatabase")
        .Options;
